      ...
      <div class="row">
        ...
        <div class="col-md-3 col-sm-6">
          <div class="feature text-center">
            ...
            <h4 class="feature-title" style="text-transform: uppercase">Design</h4>
            <p class="feature-text">Find a design that speaks to you.</p>
          </div>
        </div>
        <!-- Feature -->
        <div class="col-md-3 col-sm-6">
          <div class="feature text-center">
            ...
            <h4 class="feature-title" style="text-transform: uppercase">Customize</h4>
            <p class="feature-text">Choose a wood & finish that suits your space.</p>
          </div>
        </div>
        <!-- Feature -->
        <div class="col-md-3 col-sm-6">
          <div class="feature text-center">
            ...
            <h4 class="feature-title" style="text-transform: uppercase">Pay</h4>
            <p class="feature-text">Get one simple, transparent price. No stressful 
            negotiating war necessary.</p>
          </div>
        </div>
        <!-- Feature -->
        <div class="col-md-3 col-sm-6">
      ...
      <div class="row padding-top">
        ...
        <div class="col-lg-9 col-md-8">
          ...
          <ul class="nav-tabs text-center" role="tablist">
            <li class="active"><a href="#dining" role="tab" data-toggle="tab">Dining</a></li>
            <li><a href="#bedroom" role="tab" data-toggle="tab">Bedroom</a></li>
            <li><a href="#living" role="tab" data-toggle="tab">Living Room</a></li>
          ...
          <div class="tab-content">
            ...
            <!-- #dining -->
            <div role="tabpanel" class="tab-pane transition fade scale in active" id="dining">
            ...
            <!-- #bedroom-->
            <div role="tabpanel" class="tab-pane transition fade scale" id="bedroom">
              <div class="row">
                <div class="col-lg-3 col-sm-6">
                  <div class="shop-item">
                    <div class="shop-thumbnail">
            ...
            </div><!-- .tab-pane#bedroom -->

            <!-- #living -->
            <div role="tabpanel" class="tab-pane transition fade scale" id="living">
              <div class="row">
                <div class="col-lg-3 col-sm-6">
                  <div class="shop-item">
                    <div class="shop-thumbnail">
            ...
            <!-- #kids -->
            <div role="tabpanel" class="tab-pane transition fade scale" id="kids">
              <div class="row">
                <div class="col-lg-3 col-sm-6">
                  <div class="shop-item">
                    <div class="shop-thumbnail">
